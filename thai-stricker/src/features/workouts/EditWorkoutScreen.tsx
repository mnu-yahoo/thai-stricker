...
function getStyles(theme: AppTheme) {
  ...
  return StyleSheet.create({
    ...
    eyebrow: {
      color: isDarkTheme ? theme.colors.primary : "#5F6A7F",
      fontSize: 13,
      fontWeight: "700",
      textTransform: "uppercase",
      letterSpacing: 0.8,
    ...
    screenTitle: {
      ...
      letterSpacing: isDarkTheme ? -0.8 : 0.2,
    ...
    textInput: {
      ...
      borderWidth: 1,
      borderColor: isDarkTheme ? "#42565B" : "#BCC7D9",
      backgroundColor: isDarkTheme ? "#1F1D20" : "#FFFFFF",
      paddingHorizontal: 16,
      paddingVertical: 14,
      color: theme.colors.textPrimary,
      fontSize: 17,
    ...
    segmentedGroup: {
      ...
      overflow: "hidden",
      backgroundColor: isDarkTheme ? "#1B1A1D" : "#F6F2EF",
    ...
    segmentedButtonSelected: {
      ...
      borderColor: isDarkTheme ? "transparent" : "#2364D0",
      shadowColor: isDarkTheme ? "transparent" : "#2364D0",
      shadowOpacity: isDarkTheme ? 0 : 0.12,
      shadowRadius: isDarkTheme ? 0 : 8,
      shadowOffset: isDarkTheme ? undefined : { width: 0, height: 4 },
    ...
    segmentedButtonTextSelected: {
      color: isDarkTheme ? theme.colors.primaryText : "#FFFFFF",
    },
    durationDisplay: {
      minHeight: 44,
      borderRadius: isDarkTheme ? 4 : 10,
      borderWidth: 1,
      borderStyle: "dashed",
      borderColor: isDarkTheme ? "#58696E" : "#BCC7D9",
      alignItems: "center",
      justifyContent: "center",
    ...
    durationDisplayText: {
      ...
      fontSize: 16,
      fontWeight: isDarkTheme ? "500" : "700",
      textTransform: "uppercase",
      letterSpacing: 2,
    },
    chipGroup: {
    ...
    chipButton: {
      ...
      borderWidth: 1,
      borderColor: isDarkTheme ? "#56656A" : "#BCC7D9",
      backgroundColor: isDarkTheme ? "#202023" : "#F6F2EF",
      alignItems: "center",
      justifyContent: "center",
    },
    chipButtonSelected: {
      ...
      shadowRadius: 8,
      backgroundColor: isDarkTheme ? "#162A2D" : "#EAF1FF",
    ...
    inlineActionText: {
      color: isDarkTheme ? theme.colors.primary : "#206BE0",
      fontSize: 12,
      fontWeight: "800",
      textTransform: "uppercase",
      letterSpacing: 0.8,
    ...
    selectedCountBadgeText: {
      color: isDarkTheme ? theme.colors.primary : "#2364D0",
    ...
    secondaryActionButton: {
      ...
      borderWidth: 1,
      borderColor: isDarkTheme ? "#56656A" : "#D7E0EF",
      backgroundColor: isDarkTheme ? "#1F1D20" : "#FFFFFF",
      alignItems: "center",
      justifyContent: "center",
    },
